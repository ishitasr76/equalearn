...
q2a3.addEventListener("click", Correct);
...
q4a3.addEventListener("click", Incorrect);
q4a4.addEventListener("click", Correct);
...
function Incorrect(){
  ...
  function ianswer(){
    result.innerHTML = "You got the answer incorrect :)"
  }
